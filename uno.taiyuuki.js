const shadow = [
  [
    /shadow-([\d.]+)(\W*)/,
    ([, d, u]) => ({ 'box-shadow': ` 0 0 ${d}${u || 'px'} black` }),
  ],
  [
    /shadow-([A-z-]+)-([\d.]+)(\W*)/,
  ...
  [
    /shadow-inner-([A-z-]+)-([\d.]+)(\W*)/,
    ([, c, d, u]) => ({ 'box-shadow': `inner 0 0 ${d}${u || 'px'} var(--${c})` }),
  ],
  [
    /shadow-inset-([A-z-]+)-([\d.]+)(\W*)/,
    ([, c, d, u]) => ({ 'box-shadow': `inset 0 0 ${d}${u || 'px'} var(--${c})` }),
  ],
]
...
const margin = [
  ...
  [
    /^m-l-([\d.]+)(\D*)$/,
    ([, d, w]) => ({ 'margin-left': `${d}${w || 'px'}` }),
  ],
  [
    /^m-r-([\d.]+)(\D*)$/,
    ([, d, w]) => ({ 'margin-right': `${d}${w || 'px'}` }),
  ],
  [
    /^m-t-([\d.]+)(\D*)$/,
    ([, d, w]) => ({ 'margin-top': `${d}${w || 'px'}` }),
  ],
  [
    /^m-b-([\d.]+)(\D*)$/,
    ([, d, w]) => ({ 'margin-bottom': `${d}${w || 'px'}` }),
  ],
]
...
const padding = [
  ...
  [
    /^p-l-([\d.]+)(\D*)$/,
    ([, d, w]) => ({ 'padding-left': `${d}${w || 'px'}` }),
  ],
  [
    /^p-r-([\d.]+)(\D*)$/,
    ([, d, w]) => ({ 'padding-right': `${d}${w || 'px'}` }),
  ],
  [
    /^p-t-([\d.]+)(\D*)$/,
    ([, d, w]) => ({ 'padding-top': `${d}${w || 'px'}` }),
  ],
  [
    /^p-b-([\d.]+)(\D*)$/,
    ([, d, w]) => ({ 'padding-bottom': `${d}${w || 'px'}` }),
  ],
]
...
const content = [
  ...
  [
    /^w-max-([\d.]+)(\D*)$/,
    ([, d, w]) => ({ 'max-width': `${d}${w || 'px'}` }),
  ],
  [
    /^w-min-([\d.]+)(\D*)$/,
    ([, d, w]) => ({ 'min-width': `${d}${w || 'px'}` }),
  ],
  [
    /^h-([\d.]+)(\D*)$/,
    ([, d, w]) => ({ height: `${d}${w || 'px'}` }),
  ...
  [
    /^h-max-([\d.]+)(\D*)$/,
    ([, d, w]) => ({ 'max-height': `${d}${w || 'px'}` }),
  ],
  [
    /^h-min-([\d.]+)(\D*)$/,
    ([, d, w]) => ({ 'min-height': `${d}${w || 'px'}` }),
  ],
]
...
const icon = [
  [/^icon-color-([A-z]+)$/, ([, color]) => ({ fill: `var(--${color})` })],
  [/^icon-(#[A-Fa-f0-9]+)$/, ([, color]) => ({ fill: color })],
]
